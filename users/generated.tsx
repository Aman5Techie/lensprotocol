...
export const useExploreProfilesQuery = <
    ...
    useQuery<ExploreProfilesQuery, TError, TData>(
      ...
      fetcher<ExploreProfilesQuery, ExploreProfilesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, ExploreProfilesDocument, variables),
      options
    );
...
export const useSearchProfilesQuery = <
    ...
    useQuery<SearchProfilesQuery, TError, TData>(
      ...
      fetcher<SearchProfilesQuery, SearchProfilesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, SearchProfilesDocument, variables),
      options
    );
...
export const useSearchPublicationsQuery = <
      TData = SearchPublicationsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables: SearchPublicationsQueryVariables,
      options?: UseQueryOptions<SearchPublicationsQuery, TError, TData>
    ) =>
    useQuery<SearchPublicationsQuery, TError, TData>(
      ['SearchPublications', variables],
      fetcher<SearchPublicationsQuery, SearchPublicationsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, SearchPublicationsDocument, variables),
      options
    );
